...
export declare class QuarterService {
    ...
    private apiService;
    constructor(quarterModel: Model<QuarterDocument>, apiService: ApiService<QuarterDocument, FindQuery>);
    ...
    findQuarterContainingPoint(body: PointDto): Promise<import("mongoose").Document<unknown, {}, import("mongoose").Document<unknown, {}, Quarter> & Quarter & {
