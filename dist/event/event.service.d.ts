...
export declare class EventService {
    ...
    updateEvent(eventId: string, body: UpdateEventDto, user: string): Promise<{
        event: import("mongoose").Document<unknown, {}, import("mongoose").Document<unknown, {}, import("./event.schema").Event> & import("./event.schema").Event & {
            _id: import("mongoose").Types.ObjectId;
        }> & import("mongoose").Document<unknown, {}, import("./event.schema").Event> & import("./event.schema").Event & {
            _id: import("mongoose").Types.ObjectId;
    ...
    deleteEvent(eventId: string, user: string): Promise<{
        status: string;
    }>;
    ...
    getAllPreviousReservedEvents(obj: QueryEventDto, user: string): Promise<{
        events: (import("mongoose").Document<unknown, {}, import("./event.schema").Event> & import("./event.schema").Event & {
            _id: import("mongoose").Types.ObjectId;
        })[];
        pagination: import("src/common/Api/api.service").Pagination;
    }>;
    getAllFutureEvents(obj: QueryEventDto, user: string): Promise<{
        events: (import("mongoose").Document<unknown, {}, import("./event.schema").Event> & import("./event.schema").Event & {
            _id: import("mongoose").Types.ObjectId;
        })[];
        pagination: import("src/common/Api/api.service").Pagination;
    }>;
    addLike(eventId: string, user: string): Promise<{
        status: string;
    }>;
    removeLike(eventId: string, user: string): Promise<{
        status: string;
    }>;
    getLikes(eventId: string, query: FindQuery): Promise<{
        likes: (import("mongoose").Document<unknown, {}, import("../likes/likes.schema").Likes> & import("../likes/likes.schema").Likes & {
            _id: import("mongoose").Types.ObjectId;
        })[];
        pagination: import("src/common/Api/api.service").Pagination;
    }>;
    addComment(body: CreateCommentDto, eventId: string, user: string): Promise<import("mongoose").Document<unknown, {}, import("mongoose").Document<unknown, {}, import("../comment/comment.schema").Comment> & import("../comment/comment.schema").Comment & {
        _id: import("mongoose").Types.ObjectId;
    ...
    getComments(eventId: string, query: FindQuery): Promise<{
        comments: (import("mongoose").Document<unknown, {}, import("../comment/comment.schema").Comment> & import("../comment/comment.schema").Comment & {
            _id: import("mongoose").Types.ObjectId;
        })[];
        pagination: import("src/common/Api/api.service").Pagination;
    }>;
    addSaved(eventId: string, user: string): Promise<{
        status: string;
    }>;
    deleteSaved(eventId: string, user: string): Promise<{
        status: string;
    }>;
    getAllSaved(eventId: string, query: FindQuery): Promise<{
        totalPages: number;
        page: number;
        limit: number;
        saved: {
