...
export declare class ChatService {
  ...
  constructor(
    ...
    apiService: ApiService<ChatDocument, FindQuery>,
  ...
  createChat(
    ...
    messages: (import('mongoose').Document<
      ...
      import('mongoose').Document<
        unknown,
        {},
        import('../message/messahe.schema').Message
      > &
        import('../message/messahe.schema').Message & {
    ...
    chat: import('mongoose').Document<
      unknown,
      {},
      import('mongoose').Document<unknown, {}, Chat> &
        Chat & {
          _id: import('mongoose').Types.ObjectId;
        }
    > &
  ...
  getChats(
    ...
    chats: (import('mongoose').Document<unknown, {}, Chat> &
      Chat & {
        _id: import('mongoose').Types.ObjectId;
      })[];
