...
export declare class VoluntaryController {
    ...
    getAllVoluntarys(query: QueryVoluntaryDto): Promise<{
        voluntarys: (import("mongoose").Document<unknown, {}, import("./voluntary.schema").Voluntary> & import("./voluntary.schema").Voluntary & {
            _id: import("mongoose").Types.ObjectId;
        })[];
    ...
    deleteVoluntaryComment(voluntaryId: string, commentId: string, req: any): Promise<{
        status: string;
    }>;
