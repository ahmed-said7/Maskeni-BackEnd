...
export declare class VoluntaryService {
  ...
  private apiService;
  constructor(
    voluntaryModel: Model<VoluntaryDocument>,
    userModel: Model<UserDocument>,
    reactionService: ReactionService<VoluntaryDocument>,
    apiService: ApiService<VoluntaryDocument, QueryVoluntaryDto>,
  );
  createVoluntary(
    body: CreateVoluntaryDto,
    user: string,
  ): Promise<{
    voluntary: import('mongoose').Document<
      unknown,
      {},
      import('mongoose').Document<unknown, {}, Voluntary> &
        Voluntary & {
