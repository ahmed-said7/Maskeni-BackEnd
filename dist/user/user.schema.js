...
], User.prototype, "savedGroupPost", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        _id: mongoose_2.Types.ObjectId,
    ...
    __metadata("design:type", Array)
], User.prototype, "savedEvent", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        _id: mongoose_2.Types.ObjectId,
        share: { type: mongoose_2.Types.ObjectId, ref: share_schema_1.Share.name },
        createdAt: { type: Date, default: new Date() },
    }),
    __metadata("design:type", Array)
], User.prototype, "savedShare", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        _id: mongoose_2.Types.ObjectId,
        question: { type: mongoose_2.Types.ObjectId, ref: question_schema_1.Question.name },
        createdAt: { type: Date, default: new Date() },
    }),
    __metadata("design:type", Array)
], User.prototype, "savedQuestion", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        _id: mongoose_2.Types.ObjectId,
        voluntary: { type: mongoose_2.Types.ObjectId, ref: voluntary_schema_1.Voluntary.name },
        createdAt: { type: Date, default: new Date() },
    }),
    __metadata("design:type", Array)
], User.prototype, "savedVoluntary", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        _id: mongoose_2.Types.ObjectId,
...
__decorate([
    (0, mongoose_1.Prop)({
        _id: mongoose_2.Types.ObjectId,
        service: { type: mongoose_2.Types.ObjectId, ref: offered_service_schema_1.Offered.name },
        createdAt: { type: Date, default: new Date() },
    }),
    __metadata("design:type", Array)
], User.prototype, "savedService", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        _id: mongoose_2.Types.ObjectId,
        service: { type: mongoose_2.Types.ObjectId, ref: offered_service_schema_1.Offered.name },
    ...
    __metadata("design:type", Array)
], User.prototype, "requestedService", void 0);
__decorate([
...
], User.prototype, "verificationExpiresIn", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: String }),
    __metadata("design:type", String)
...
__decorate([
    (0, mongoose_1.Prop)({ type: Number, default: 0 }),
    __metadata("design:type", Number)
], User.prototype, "ratingQuantity", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: String }),
    __metadata("design:type", String)
