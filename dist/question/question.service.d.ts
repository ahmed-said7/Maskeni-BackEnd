...
export declare class QuestionService {
  ...
  constructor(
    ...
    reactionService: ReactionService<QuestionDocument>,
    apiService: ApiService<QuestionDocument, FindQuery>,
  );
  createQuestion(
    body: CreateShareDto,
    user: string,
    ...
    question: import('mongoose').Document<
      unknown,
      {},
      import('mongoose').Document<unknown, {}, Question> &
        Question & {
  ...
  getAllQuestion(obj: QueryQuestionDto): Promise<{
    questions: (import('mongoose').Document<unknown, {}, Question> &
      Question & {
        _id: import('mongoose').Types.ObjectId;
      })[];
