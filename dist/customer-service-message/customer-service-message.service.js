  ...
  async createMessage(body, user, role) {
    ...
    body.type =
      role == enum_1.All_Role.User
        ? user_schema_1.User.name
        : admin_schema_1.Admin.name;
  ...
  async joinChatByAdmin(chatId, user) {
    ...
    const messages = await this.msgModel
      ...
      .populate([
        {
          path: 'user',
          model: admin_schema_1.Admin.name,
    ...
    [
      ...
      __param(
        ...
        (0, mongoose_1.InjectModel)(
          customer_service_chat_schema_1.CustomerServiceChat.name,
        ),
      ),
      __param(
        1,
        (0, mongoose_1.InjectModel)(
          customer_service_message_schema_1.CustomerServiceMessage.name,
        ),
      ),
