...
__decorate(
  ...
  CustomerServiceMessage.prototype,
  'content',
  void 0,
);
__decorate(
  [
    (0, mongoose_1.Prop)({
      ...
      ref: customer_service_chat_schema_1.CustomerServiceChat.name,
    }),
...
exports.CustomerServiceMessageSchema = mongoose_1.SchemaFactory.createForClass(
  CustomerServiceMessage,
);
