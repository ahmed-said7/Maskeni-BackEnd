...
__decorate(
  ...
  CustomerServiceMessageController.prototype,
  'createMessage',
  null,
);
__decorate(
  [
    ...
    __param(
      0,
      (0, common_1.Param)('user', validate_mongo_pipe_1.ValidateObjectIdPipe),
    ),
    __param(1, (0, common_1.Req)()),
    ...
    __metadata('design:paramtypes', [
      String,
      Object,
      create_message_dto_1.CreateAdminMessageDto,
    ]),
    __metadata('design:returntype', void 0),
  ],
  CustomerServiceMessageController.prototype,
...
__decorate(
  [
    ...
    __param(
      0,
      (0, common_1.Param)('chatId', validate_mongo_pipe_1.ValidateObjectIdPipe),
    ),
    __param(1, (0, common_1.Req)()),
    ...
    __metadata('design:paramtypes', [
      String,
      Object,
      query_message_dto_1.QueryMessageDto,
    ]),
    __metadata('design:returntype', void 0),
  ],
  CustomerServiceMessageController.prototype,
