...
exports.CustomerServiceMessageModule = CustomerServiceMessageModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                ...
                {
                    name: customer_service_message_schema_1.CustomerServiceMessage.name,
                    schema: customer_service_message_schema_1.CustomerServiceMessageSchema,
                },
                {
