...
import { CustomerServiceMessage, CustomerServiceMessageDocument } from './customer-service-message.schema';
import { EventEmitter2 } from '@nestjs/event-emitter';
export declare class CustomerServiceMessageService {
    private chatModel;
    private msgModel;
    private eventEmitter;
    constructor(chatModel: Model<CustomerServiceChatDocument>, msgModel: Model<CustomerServiceMessageDocument>, eventEmitter: EventEmitter2);
    createMessage(body: CreateMessageDto, user: string, role: string): Promise<{
        message: import("mongoose").Document<unknown, {}, import("mongoose").Document<unknown, {}, CustomerServiceMessage> & CustomerServiceMessage & {
    ...
    sendMessageByAdmin(body: CreateAdminMessageDto, user: string, admin: string): Promise<{
        status: string;
    }>;
    private handleChatJoin;
    private validateChat;
    joinChatByAdmin(chatId: string, user: string): Promise<{
