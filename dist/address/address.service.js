...
let AddressService = class AddressService {
    ...
    async findAll(obj, userId) {
        obj.user = userId;
        const { query, paginationObj } = await this.apiService.getAllDocs(this.addressModel.find(), obj);
    ...
    async update(id, updateAddressDto) {
        const updatedAddress = await this.addressModel.findByIdAndUpdate(id, updateAddressDto, { new: true });
        if (!updatedAddress) {
