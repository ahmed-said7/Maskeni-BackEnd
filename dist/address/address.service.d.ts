...
export declare class AddressService {
    ...
    private apiService;
    constructor(addressModel: Model<AddressDocument>, apiService: ApiService<AddressDocument, AddressQueryDto>);
    create(createAddressDto: CreateAddressDto): Promise<Address>;
    findAll(obj: AddressQueryDto, userId: string): Promise<{
        addresse: (import("mongoose").Document<unknown, {}, Address> & Address & {
