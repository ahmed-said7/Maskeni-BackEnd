...
export declare class ReviewService {
    ...
    createReview(body: CreateReviewDto, userId: string): Promise<{
    ...
    updateReview(body: UpdateReviewDto, reviewId: string, user: string): Promise<{
        status: string;
    }>;
    deleteReview(reviewId: string, user: string): Promise<{
        status: string;
    }>;
