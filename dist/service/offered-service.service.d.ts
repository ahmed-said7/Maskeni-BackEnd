...
export declare class OfferedService {
  ...
  private apiService;
  constructor(
    serviceModel: Model<OfferedDocument>,
    userModel: Model<UserDocument>,
    reactionService: ReactionService<OfferedDocument>,
    apiService: ApiService<OfferedDocument, QueryOfferedDto>,
  );
  createService(
    ...
    service: import('mongoose').Document<
      unknown,
      {},
      import('mongoose').Document<unknown, {}, Offered> &
        Offered & {
  ...
  getAllservices(obj: QueryOfferedDto): Promise<{
    services: (import('mongoose').Document<unknown, {}, Offered> &
      Offered & {
        _id: import('mongoose').Types.ObjectId;
      })[];
