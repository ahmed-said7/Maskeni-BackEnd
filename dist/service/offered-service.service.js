...
let OfferedService = class OfferedService {
    ...
    async getAllservices(obj) {
        const { query, paginationObj } = await this.apiService.getAllDocs(this.serviceModel.find(), obj);
...
exports.OfferedService = OfferedService = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(offered_service_schema_1.Offered.name)),
