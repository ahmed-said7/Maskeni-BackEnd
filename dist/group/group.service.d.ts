...
export declare class GroupServices {
  ...
  constructor(
    ...
    apiService: ApiService<GroupDocument, FindQuery>,
  );
  getAllGroups(
    obj: FindQuery,
    filter?: object,
  ): Promise<{
    groups: (import('mongoose').Document<unknown, {}, Group> &
      Group & {
  ...
  createGroup(
    ...
    group: import('mongoose').Document<
      unknown,
      {},
      import('mongoose').Document<unknown, {}, Group> &
        Group & {
          _id: import('mongoose').Types.ObjectId;
        }
    > &
