...
export declare class PostController {
    ...
    deletePostComment(req: any, commentId: string): Promise<{
        status: string;
    }>;
    addLike(req: any, postId: string): Promise<{
        status: string;
    }>;
    removeLike(req: any, postId: string): Promise<{
        status: string;
    }>;
    getLike(req: any, postId: string, query: FindQuery): Promise<{
        likes: (import("mongoose").Document<unknown, {}, import("../likes/likes.schema").Likes> & import("../likes/likes.schema").Likes & {
            _id: import("mongoose").Types.ObjectId;
        })[];
        pagination: import("../common/Api/api.service").Pagination;
    }>;
    createPost(req: any, body: CreatePostDto): Promise<{
        post: import("mongoose").Document<unknown, {}, import("mongoose").Document<unknown, {}, import("./post.schema").Post> & import("./post.schema").Post & {
            _id: import("mongoose").Types.ObjectId;
    ...
    getUserGroupsPosts(req: any, query: FindQuery): Promise<{
        posts: (import("mongoose").Document<unknown, {}, import("../group/group.schema").Group> & import("../group/group.schema").Group & {
            _id: import("mongoose").Types.ObjectId;
        })[];
        pagination: import("../common/Api/api.service").Pagination;
    }>;
    getGroupPosts(req: any, groupId: string, query: FindQuery): Promise<{
        posts: (import("mongoose").Document<unknown, {}, import("../group/group.schema").Group> & import("../group/group.schema").Group & {
            _id: import("mongoose").Types.ObjectId;
        })[];
        pagination: import("../common/Api/api.service").Pagination;
    ...
    updatePost(req: any, postId: string, body: UpdatePostDto): Promise<{
        status: string;
        post: import("mongoose").Document<unknown, {}, import("mongoose").Document<unknown, {}, import("./post.schema").Post> & import("./post.schema").Post & {
            _id: import("mongoose").Types.ObjectId;
        }> & import("mongoose").Document<unknown, {}, import("./post.schema").Post> & import("./post.schema").Post & {
